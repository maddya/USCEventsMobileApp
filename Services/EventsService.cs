	...
	public class EventsService
	{
		...
		public List<Event> GetDummyEvents()
		{
			...
			events.Add(new Event { Title = "Bass Academy", 
                ...
                StartDateAndTime = DateTime.Parse("5/22/2017 8:00AM"),
                EndDateAndTime = DateTime.Parse("5/23/2017 2:00AM")});
			events.Add(new Event { Title = "Life in Color",
                ...
                StartDateAndTime = DateTime.Parse("9/10/2017 9:30PM"),
                EndDateAndTime = DateTime.Parse("9/11/2017 2:00AM")});
			events.Add(new Event { Title = "Bliss",
				Venue = "Tacoma Dome",
				VenueAdress = "2727 E D St Tacoma, WA",
				Description = "This show is going to be PURE BLISS.",
                StartDateAndTime = DateTime.Parse("10/10/2017 10:00PM"),
                EndDateAndTime = DateTime.Parse("10/10/2017 10:00PM")});
			events.Add(new Event { Title = "Paradiso",
                ...
                StartDateAndTime = DateTime.Parse("9/8/2017 10:00AM"),
                EndDateAndTime = DateTime.Parse("9/11/2017 8:00PM")});
			events.Add(new Event { Title = "Magnifique",
				Venue = "The Gorge",
				VenueAdress = "754 Silica Road NW George, WA",
				Description = "Another big concert at a sweet venue!",
                StartDateAndTime = DateTime.Parse("11/10/2017 8:00PM"),
                EndDateAndTime = DateTime.Parse("11/12/2017 2:00AM")});
			return events;
		}
	}
}
